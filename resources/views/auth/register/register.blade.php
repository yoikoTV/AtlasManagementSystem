...
<body class="all_content">
    <form action="{{ route('registerPost') }}" method="POST">
        <div class="w-100 vh-100 d-flex" style="align-items:center; justify-content:center;">
            <div class="form_container border shadow p-4" style="width:350px">
                <div class="register_form">
                    ...
                    <div class="d-flex flex-column mt-3" style="justify-content:space-between">
                ...
                <div class="mt-3">
                    ...
                    <div class="d-flex" style="justify-content:space-between">
                        <div>
                            <select class="old_year birth_day border-primary" name="old_year">
                        ...
                        <div>
                            <select class="old_month birth_day border-primary" name="old_month">
                                <option value="none">-----</option>
                        ...
                        <div>
                            <select class="old_day birth_day border-primary" name="old_day">
                                <option value="none">-----</option>
                                <option value="01">1</option>
                                <option value="02">2</option>
                                <option value="03">3</option>
